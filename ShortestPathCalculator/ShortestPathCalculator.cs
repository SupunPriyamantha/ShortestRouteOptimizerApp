...
namespace ShortestPathCalculator
{
    public class ShortestPathCalculator
    {
        ...
        {
            int[,] graph = NodeModel.NodeGraph;
            int startNodeIndex = startNode.GetPosition();
            int finishNodeIndex = finishNode.GetPosition();
            ...
            List<string> nodePath = path.Select(x => x.GetNodeValueUsingPosition()).ToList();
        ...
        public void PrintShortestPathData(ShortestPathDto shortestPathData)
        {
